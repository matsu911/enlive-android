...
(defn- load-html-resource 
 ...
 (filter map?
         (with-open [^java.io.Closeable stream stream]
           (xml/parse 
            (doto (org.xml.sax.InputSource. stream)
...
(defn html-resource 
 ...
 [resource encoding]
  (get-resource resource (fn [stream] (load-html-resource stream encoding))))
